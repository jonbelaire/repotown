...
func (s *Server) setupRoutes(r chi.Router) {
	...
	r.Route("/api", func(r chi.Router) {
		// Create handlers
		accountHandler := NewAccountHandler(s.services.Account, s.logger)
		customerHandler := NewCustomerHandler(s.services.Customer, s.services.Account, s.logger)
		transactionHandler := NewTransactionHandler(s.services.Transaction, s.logger)
