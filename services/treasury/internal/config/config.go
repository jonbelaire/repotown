...
type Config struct {
	// Server settings
	ServerAddress   string        `envconfig:"SERVER_ADDRESS" default:":8083"`
	...
	JWTIssuer string        `envconfig:"JWT_ISSUER" default:"treasury-service"`
	
	// Tax settings
	DefaultJurisdiction string `envconfig:"DEFAULT_JURISDICTION" default:"CITYTOWN"`
	TaxDataRetention    time.Duration `envconfig:"TAX_DATA_RETENTION" default:"84000h"` // 10 years retention by default
}
