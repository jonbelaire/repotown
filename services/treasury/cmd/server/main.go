...
import (
	...
	"github.com/jonbelaire/repotown/services/treasury/internal/api"
	treasuryConfig "github.com/jonbelaire/repotown/services/treasury/internal/config"
)

func main() {
	// Load configuration
	cfg := treasuryConfig.Config{}
